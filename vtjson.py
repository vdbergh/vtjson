...
class _union:
    ...
    def __validate__(self, object, name=None, strict=True):
        messages = []
...
class quote:
    ...
    def __validate__(self, object, name=None, strict=True):
        return self.schema.__validate__(object, name=name, strict=strict)
...
class _deferred:
    ...
    def __validate__(self, object, name=None, strict=True):
        ...
        return self.collection[self.key].__validate__(object, name=name, strict=strict)
...
class _ifthen:
    ...
    def __validate__(self, object, name=None, strict=True):
        if self.if_schema.__validate__(object, name=name, strict=strict) == "":
            return self.then_schema.__validate__(object, name=name, strict=strict)
        elif self.else_schema is not None:
            return self.else_schema.__validate__(object, name=name, strict=strict)
        return ""
...
class _cond:
    ...
    def __validate__(self, object, name=None, strict=True):
        for c in self.conditions:
            if c[0].__validate__(object, name=name, strict=strict) == "":
                return c[1].__validate__(object, name=name, strict=strict)
        return ""
...
class _fields:
    ...
    def __validate__(self, object, name=None, strict=strict):
...
class _filter:
    ...
    def __validate__(self, object, name=None, strict=strict):
        ...
        return self.schema.__validate__(object, name=None, strict=strict)
...
class _sequence:
    ...
    def __validate_ellipsis__(self, object, name=None, strict=True):
        if self.type_schema is not type(object):
            return _wrong_type_message(object, name, type(self.schema).__name__)
        ls = len(self.schema)
        lo = len(object)
...
class _const:
    ...
    def __validate_float__(self, object, name=None, strict=True):
        try:
